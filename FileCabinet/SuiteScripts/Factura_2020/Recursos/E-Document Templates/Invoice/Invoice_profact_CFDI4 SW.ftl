...
<cfdi:Comprobante
        ...
        <#if transaction.custbody_mx_cfdi_sat_addendum?has_content && (Add_name=="Liverpool" || Add_name=="HEB")>
            <#assign xsischemalocation_add = " http://www.sat.gob.mx/detallista http://www.sat.gob.mx/sitio_internet/cfd/detallista/detallista.xsd">
