...
define(['N/search', 'N/ui/serverWidget'],
    ...
    (search, serverWidget) => {
        ...
        const onRequest = (scriptContext) => {
            try {
                ...
                let form = serverWidget.createForm({
                    title: "Dashboard Factura Electrónica",
                    hideNavBar: false
                });
        ...
        const getHTMLTemplate = () => {
            try {
                let content = '';
                let cssFile = getFileURL('app.9ceca87c.css');
                let chunkCssFile = getFileURL('chunk-vendors.a38d9a19.css');
                let appJSFile = getFileURL('app.ffff01b1.js');
                let chunkFile = getFileURL('chunk-vendors.525c58a2.js');
